 ...
 *
 */
public class ChampernowneModel implements Number {
	LinkedHashMap<Integer,String> hashLetters=new LinkedHashMap<Integer,String>();
	Calculator calculator;
	
	/**
	 * Getter of hashLetters Hash
	 * @return HashLetters parameter
	 */
	public LinkedHashMap<Integer, String> getHashLetters() {
		return hashLetters;
	}

	/**
	 * Setter of hashLetters 
	 * @param hashLetters The hash
	 */
	public void setHashLetters(LinkedHashMap<Integer, String> hashLetters) {
		this.hashLetters = hashLetters;
	}

	/**
	 * getter of calculator
	 * @return the calculator attribute
	 */
	...
	/**
	 * setter of calculator
	 * @param calculator new value
	 */
	 ...
	 */
	public ChampernowneModel(){
		this.calculator=new Calculator();
		//Cipher Hash
		
		this.hashLetters.put(0, "À");
	...
	public int getPatternPosition(String pattern, String number) {
		return number.indexOf(pattern)+1;
	}
	 ...
	 * @return the number
	 */
	public static String calculate(int decimals, double base){
		double result;
		...
		for(int i=1;i<=decimals;i++){
			...
			for(int j=1;j<=i;j++){
				double aux=j;
				result=result+Calculator.floor(log(base,aux));
			}
			result=result+i;
			result=Calculator.pow(base,(int) result);
			result=i/result;
			finalResult=finalResult+result;
		}
		return (String.valueOf(finalResult)).substring(0,decimals+2);
	}
	 ...
	 */
	 public static double log(double base, double valor) {
	        return Calculator.log2(valor) / Calculator.log2(base);
	 }
	 ...
	 * @param number the number used for encryption
	 * @return encrypted message result
	 */
	public String encryptMessage(String message, String number){
		int n = ((message.toCharArray().length*2)%50)+1;
	 ...
	 * @param message the message
	 * @param number the number used to decrypt
	 * @param key the key
	...
	/**
	 * Executes the encryption using substitution
	 * @param messageToEncrypt the message
	 * @return encrypted message the result
	 */
	public String encryptSubtitution(String messageToEncrypt){
		String numeroAlter=calculateAlternative(600,10);
	...
	/**
	 * Executes decryption using substitution
	 * @param message the message
	 * @param key the key
	 * @return decrypted message the result
	 */
	...
	/**
	 * Decrypt given a number using one-time pad
	 * @param message the message
	 * @param number the number
	 * @param key the key
	...
	/**
	 * Encrypts using one-time pad
	 * @param message the message
	 * @return Encrypted message
	 */
	public String encryptOneTimePad(String message){
		return encryptMessageOneTime(message, calculateAlternative(500*8+70,2));
	}


	/**
	 * Decrypts using one-time pad
	 * @param message the message
	 * @param key the key
	 * @return the decrypted message
	 */
	public String decryptOneTimePad(String message, int key){
		return decryptMessageOneTime(message, calculateAlternative(500*8+70,2), key);
	}
